        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Slack',
                href: 'https://people-data.slack.com',
              },
              {
                label: 'Twitter',
                href: 'https://twitter.com/jerry.Z',
              },
            ],
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/peopledata',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Peopledata.org.cn. Built with Docusaurus.`,
      },
      prism: {
